 ...
 *
 * @method DexterousApi getApiHelper
 */
class DexterousIntegration extends CrmAbstractIntegration
{
    /**
     * @var UserHelper
     */
    ...
    {
        return [
                $this->getClientIdKey()     => 'mautic.dexterous.form.email',
                $this->getClientSecretKey() => 'mautic.dexterous.form.password',
        ...
        if ($formArea == 'features') {
            $builder->add(
                ...
                [
                    ...
                    'expanded'    => true,
                    'multiple'    => true,
                    'label'       => $this->getTranslator()->trans('mautic.crm.form.objects_to_pull_from', ['%crm%' => 'Dexterous']),
                    'label_attr'  => ['class' => ''],
                    'empty_value' => false,
                    'required'    => false,
                ]
